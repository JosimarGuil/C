...
/* Conta palavras separadas por sep */
...
/* Preenche uma palavra copiando l caracteres de *str (recebe ponteiro por referência) */
...
/* Preenche array de palavras (assume memória para words alocada) */
...
/* ft_split: se não houver palavras, retorna array com apenas NULL (não NULL) */
char **ft_split(char *str, char sep)
{
	...
	/* Se não houver palavras, devolver array com apenas NULL para consistência */
	if (total_words == 0)
	{
